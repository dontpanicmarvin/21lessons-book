...
A força destrutiva da inflação torna-se óbvia assim que um pouco de inflação se transforma em \textit{muita}. Se a moeda chega a ser hiperinflacionada, as coisas ficam feias rapidamente. \footnote{\url{https://en.wikipedia.org/wiki/Hyperinflation} \cite{wiki:hyperinflation}} Conforme o poder de compra da moeda inflacionada se desfaz, ela deixará de armazenar valor com o tempo, com isso as pessoas correrão para colocar seu dinheiro em bens que possam servir como reserva de valor.
